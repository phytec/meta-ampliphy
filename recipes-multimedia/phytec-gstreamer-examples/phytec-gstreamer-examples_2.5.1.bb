...
#   $ mv gstreamer_examples phytec-gstreamer-examples-2.5.1
#   $ rm phytec-gstreamer-examples-2.5.1/tools/i2c
#   $ cp phytec-gstreamer-examples-2.5.0/tools/i2c.c phytec-gstreamer-examples-2.5.1/tools/
#   $ cp phytec-gstreamer-examples-2.5.0/COPYING.MIT  phytec-gstreamer-examples-2.5.1/
#   $ find phytec-gstreamer-examples-2.5.1/ -exec "touch" "{}" ";"
#   $ find phytec-gstreamer-examples-2.5.1/ -name "*.sh" -exec "chmod" "+x" "{}" ";"
#   $ tar --owner=root --group=root -czf phytec-gstreamer-examples-2.5.1.tar.gz \
#        phytec-gstreamer-examples-2.5.1/
